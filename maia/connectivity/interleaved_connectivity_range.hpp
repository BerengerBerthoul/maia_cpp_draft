...
#include "maia/connectivity/interleaved_connectivity_view.hpp"
...
class interleaved_connectivity_iterator {
  ...
  // type traits
    ...
    using connec_view_type = interleaved_connectivity_view<I,kind>;
  ...
  // accessors
    ...
    auto operator*() const -> connec_view_type { return {ptr}; }
...
class interleaved_connectivity_range {
  ...
  // type traits
    ...
    using reference = interleaved_connectivity_view<I,kind>;
    using const_reference = interleaved_connectivity_view<const I,kind>;
