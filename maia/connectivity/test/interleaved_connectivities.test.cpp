...
TEST_CASE("interleaved ngon connectivity") {
  ...
  SUBCASE("test__heterogeneous_connectivities,vertices") {
  ...
  SUBCASE("test__heterogeneous_connectivities,index_table") {
  ...
  SUBCASE("test__heterogeneous_connectivities,random_iterator") {
  ...
  SUBCASE("test__heterogeneous_connectivities,random_access_range") {
